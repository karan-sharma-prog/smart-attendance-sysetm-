    ...
    <div className="p-8 space-y-8">
      <header className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-semibold shadow-lg shadow-indigo-100 transition-all flex items-center gap-2"
        >
        ...
        <div className="space-y-6">
          <div className="glass-card p-6 rounded-2xl shadow-sm">
            ...
            <div className="space-y-4">
              {classes.map((cls) => (
                <div key={cls.id} className="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-indigo-200 transition-all cursor-pointer group">
                  <div className="flex justify-between items-start mb-2">
                    <h4 className="font-semibold text-slate-900 group-hover:text-indigo-600">{cls.name}</h4>
