...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 bg-indigo-600 p-12 flex flex-col justify-between text-white hidden lg:flex">
        <div>
        ...
        <div className="space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-indigo-100">Zero-touch biometric attendance marking.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-indigo-100">Anti-spoofing time-restricted QR tracking.</p>
            </div>
          </div>
        </div>
                ...
                {Object.values(UserRole).map((r) => (
                  <button
                    ...
                    className={`
                      ...
                      ${role === r ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'bg-white border-slate-200 text-slate-500 hover:border-slate-300'}
                    `}
                  >
                    {r}
                  </button>
