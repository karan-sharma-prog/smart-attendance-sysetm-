...
const Sidebar: React.FC<SidebarProps> = ({ user, onLogout }) => {
  ...
  return (
    <div className="fixed inset-y-0 left-0 w-64 bg-indigo-900 text-white flex flex-col z-50 hidden md:flex">
      <div className="p-6">
      ...
      <div className="p-4 mt-auto border-t border-indigo-800">
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-3 px-4 py-3 text-indigo-300 hover:text-white hover:bg-indigo-800 rounded-xl transition-all"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
